  ...
  <div class="home-container">
    ...
    <header>
      <div class="header-back">
        ...
        <img class="full-img" @click="showFullScreen" src="../../assets/fullscreen.png" />
      </div>
      <div class="header-city">
        <p>三维展示系统</p>
        <dv-decoration-5 style="width: 300px; height: 400px" />
      </div>
      <div class="right">
        <div>
    ...
    <section ref="sectionRef">
      ...
      <div class="data-info">
        <ul>
          <li v-for="item in cityInfoList" :key="item.id" :class="[{ 'u-iotdoor': item.id === 'u-iotdoor' }, { 'u-city': item.id === 'u-city' }, { 'u-community': item.id === 'u-community' }]">
            <div>
      ...
      <keep-alive>
        <UserDataPreview ref="user" :height="height" :fullscreen="fullscreen" v-if="active === 2" :riseImage="riseImage" :declineImage="declineImage"></UserDataPreview>
        <DeviceDataPreview v-if="active === 1" :height="height" :fullscreen="fullscreen" :riseImage="riseImage" :declineImage="declineImage"></DeviceDataPreview>
      </keep-alive>
    </section>
