<template>
  <div class="home-container">
    ...
    <section ref="sectionRef">
      ...
      <keep-alive>
        <user-data-preview ref="user" :height="height" :fullscreen="fullscreen" v-if="active === 2" :riseImage="riseImage" :declineImage="declineImage"></user-data-preview>
      </keep-alive>
      <keep-alive>
        <device-data-preview v-if="active === 1" :height="height" :fullscreen="fullscreen" :riseImage="riseImage" :declineImage="declineImage"></device-data-preview>
      </keep-alive>
    </section>
    <!-- 气泡详情 -->
